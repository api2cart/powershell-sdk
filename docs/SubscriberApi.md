...
# subscriber.list
try {
    $Result = Invoke-SubscriberList -Start $Start -Count $Count -Subscribed $Subscribed -StoreId $StoreId -Email $Email -Params $Params -Exclude $Exclude -CreatedFrom $CreatedFrom -CreatedTo $CreatedTo -ModifiedFrom $ModifiedFrom -ModifiedTo $ModifiedTo -PageCursor $PageCursor -ResponseFields $ResponseFields
} catch {
