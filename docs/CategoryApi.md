...
# category.add
try {
    $Result = Get-egoryAdd -Name $Name -Description $Description -ShortDescription $ShortDescription -ParentId $ParentId -Avail $Avail -CreatedTime $CreatedTime -ModifiedTime $ModifiedTime -SortOrder $SortOrder -MetaTitle $MetaTitle -MetaDescription $MetaDescription -MetaKeywords $MetaKeywords -SeoUrl $SeoUrl -StoreId $StoreId -StoresIds $StoresIds -LangId $LangId
} catch {
...
# category.assign
try {
    $Result = Get-egoryAssign -CategoryId $CategoryId -ProductId $ProductId -StoreId $StoreId
} catch {
...
# category.image.add
try {
    $Result = Get-egoryImageAdd -CategoryId $CategoryId -ImageName $ImageName -Url $Url -Type $Type -StoreId $StoreId -Label $Label -Mime $Mime -Position $Position
} catch {
...
# category.info
try {
    $Result = Get-egoryInfo -Id $Id -StoreId $StoreId -LangId $LangId -SchemaType $SchemaType -ResponseFields $ResponseFields -Params $Params -Exclude $Exclude -ReportRequestId $ReportRequestId -DisableReportCache $DisableReportCache
} catch {
...
# category.update
try {
    $Result = Get-egoryUpdate -Id $Id -Name $Name -Description $Description -ShortDescription $ShortDescription -ParentId $ParentId -Avail $Avail -SortOrder $SortOrder -ModifiedTime $ModifiedTime -MetaTitle $MetaTitle -MetaDescription $MetaDescription -MetaKeywords $MetaKeywords -SeoUrl $SeoUrl -StoreId $StoreId -StoresIds $StoresIds -LangId $LangId
} catch {
