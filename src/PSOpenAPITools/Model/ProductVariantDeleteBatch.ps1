...
ProductVariantDeleteBatch<PSCustomObject>
#>

function Initialize-ProductVariantDeleteBatch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductVariantDeleteBatch' | Write-Debug
...
Convert from JSON to ProductVariantDeleteBatch<PSCustomObject>
...
ProductVariantDeleteBatch<PSCustomObject>
#>
function ConvertFrom-JsonToProductVariantDeleteBatch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductVariantDeleteBatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductVariantDeleteBatch
