...
ProductAddBatch<PSCustomObject>
#>

function Initialize-ProductAddBatch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductAddBatch' | Write-Debug
...
Convert from JSON to ProductAddBatch<PSCustomObject>
...
ProductAddBatch<PSCustomObject>
#>
function ConvertFrom-JsonToProductAddBatch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductAddBatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductAddBatch
