...
ProductVariantUpdateBatchPayloadInner<PSCustomObject>
#>

function Initialize-ProductVariantUpdateBatchPayloadInner {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductVariantUpdateBatchPayloadInner' | Write-Debug
...
Convert from JSON to ProductVariantUpdateBatchPayloadInner<PSCustomObject>
...
ProductVariantUpdateBatchPayloadInner<PSCustomObject>
#>
function ConvertFrom-JsonToProductVariantUpdateBatchPayloadInner {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
