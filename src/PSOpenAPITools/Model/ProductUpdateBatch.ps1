...
ProductUpdateBatch<PSCustomObject>
#>

function Initialize-ProductUpdateBatch {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductUpdateBatch' | Write-Debug
...
Convert from JSON to ProductUpdateBatch<PSCustomObject>
...
ProductUpdateBatch<PSCustomObject>
#>
function ConvertFrom-JsonToProductUpdateBatch {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductUpdateBatch' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductUpdateBatch
